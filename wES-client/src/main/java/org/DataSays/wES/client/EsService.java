...
public interface EsService {
	...
	// part: string index: Default index for items which don't provide one
	// part: string type: Default document type for items which don't provide one
	@POST("_bulk")
	...
	// body:null
	// part: list name: A comma-separated list of alias names to return
	@GET("_cat/aliases")
	...
	// param: boolean v: Verbose mode. Display column headers
	// body:null
	// part: list node_id: A comma-separated list of node IDs or names to limit the returned information
	@GET("_cat/allocation")
	...
	// param: boolean v: Verbose mode. Display column headers
	// body:null
	// part: list index: A comma-separated list of index names to limit the returned information
	@GET("_cat/count")
	...
	// body:null
	// part: list fields: A comma-separated list of fields to return the fielddata size
	@GET("_cat/fielddata")
	...
	// param: boolean v: Verbose mode. Display column headers
	// body:null
	// part: list repository: Name of repository from which to fetch the snapshot information
	@GET("_cat/snapshots")
	...
	// param: boolean v: Verbose mode. Display column headers
	// body:null
	// part: string name: A pattern that returned template names must match
	@GET("_cat/templates")
	...
	// param: boolean v: Verbose mode. Display column headers
	// body:null
	// part: list thread_pool_patterns: A comma-separated list of regular-expressions to filter the thread pools in the output
	...
	// part: list scroll_id: A comma-separated list of scroll IDs to clear
	...
	// body:null
	// part: list index: Limit the information returned to a specific index
	@GET("_cluster/health")
	...
	// body:null
	// part: list index: A comma-separated list of index names; use `_all` or empty string to perform the operation on all indices
	// part: list metric: Limit the information returned to the specified metrics
	@GET("_cluster/state")
	...
	// param: time timeout: Explicit operation timeout
	// body:null
	// part: list node_id: A comma-separated list of node IDs or names to limit the returned information; use `_local` to return information from the node you're connecting to, leave empty to get information from all nodes
	@GET("_cluster/stats")
	...
	// part: list index: A comma-separated list of indices to restrict the results
	// part: list type: A comma-separated list of types to restrict the results
	@POST("_count")
	...
	// part: string index: The index of the document being count percolated.
	// part: string type: The type of the document being count percolated.
	// part: string id: Substitute the document in the request body with a document that is known by the specified id. On top of the id, the index and type parameter will be used to retrieve the document from within the cluster.
	...
	// param: string pipeline: The pipeline id to preprocess incoming documents with
	// body*:The document
	// part: string id: Document ID
	// part: string index: The name of the index
	// part: string type: The type of the document
	...
	// param: enum version_type: Specific version type
	// body:null
	// part: string id: The document ID
	// part: string index: The name of the index
	// part: string type: The type of the document
	...
	// part: list index: A comma-separated list of index names to search; use `_all` or empty string to perform the operation on all indices
	// part: list type: A comma-separated list of document types to search; leave empty to perform the operation on all types
	...
	// body:null
	// part: string id: Script ID
	// part: string lang: Script language
	...
	// part: string id: The document ID
	// part: string index: The name of the index
	// part: string type: The type of the document (use `_all` to fetch the first document matching the ID across all types)
	@HEAD("{index}/{type}/{id}")
	...
	// part: string index: The name of the index to scope the operation
	@GET("_analyze")
	...
	// body:null
	// part: list index: A comma-separated list of index name to limit the operation
	@POST("_cache/clear")
	...
	// param: enum expand_wildcards: Whether to expand wildcard expression to concrete indices that are open, closed or both.
	// body:null
	// part: list index: A comma separated list of indices to close
	@POST("{index}/_close")
	...
	// param: time master_timeout: Specify timeout for connection to master
	// body:null
	// part: list index: A comma-separated list of indices to delete; use `_all` or `*` string to delete all indices
	@DELETE("{index}")
	...
	// param: time master_timeout: Specify timeout for connection to master
	// body:null
	// part: list index: A comma-separated list of index names (supports wildcards); use `_all` for all indices
	// part: list name: A comma-separated list of aliases to delete (supports wildcards); use `_all` to delete all aliases for the specified indices.
	...
	// param: time master_timeout: Specify timeout for connection to master
	// body:null
	// part: string name: The name of the template
	...
	// param: boolean local: Return local information, do not retrieve the state from master node (default: false)
	// body:null
	// part: list index: A comma-separated list of indices to check
	@HEAD("{index}")
	...
	// param: boolean local: Return local information, do not retrieve the state from master node (default: false)
	// body:null
	// part: list index: A comma-separated list of index names to filter aliases
	// part: list name: A comma-separated list of alias names to return
	@HEAD("_alias/{name}")
	...
	// param: boolean local: Return local information, do not retrieve the state from master node (default: false)
	// body:null
	// part: list index: A comma-separated list of index names; use `_all` to check the types across all indices
	// part: list type: A comma-separated list of document types to check
	...
	// param: enum expand_wildcards: Whether to expand wildcard expression to concrete indices that are open, closed or both.
	// body:null
	// part: list index: A comma-separated list of index names; use `_all` or empty string for all indices
	@POST("_flush")
	...
	// body:null
	// part: list index: A comma-separated list of index names
	// part: list feature: A comma-separated list of features
	@GET("{index}")
	...
	// body:null
	// part: list index: A comma-separated list of index names
	// part: list type: A comma-separated list of document types
	// part: list fields: A comma-separated list of fields
	...
	// body:null
	// part: list index: A comma-separated list of index names; use `_all` or empty string to perform the operation on all indices
	// part: list name: The name of the settings that should be included
	@GET("_settings")
	...
	// param: boolean local: Return local information, do not retrieve the state from master node (default: false)
	// body:null
	// part: list name: The comma separated names of the index templates
	@GET("_template")
	...
	// param: enum expand_wildcards: Whether to expand wildcard expression to concrete indices that are open, closed or both.
	// body:null
	// part: list index: A comma separated list of indices to open
	@POST("{index}/_open")
	...
	// part: list index: A comma-separated list of index names the alias should point to (supports wildcards); use `_all` to perform the operation on all indices.
	// part: string name: The name of the alias to be created or updated
	...
	// part: list index: A comma-separated list of index names the mapping should be added to (supports wildcards); use `_all` or omit to add the mapping on all indices.
	// part: string type: The name of the document type
	...
	// part: string alias: The name of the alias to rollover
	// part: string new_index: The name of the rollover index
	...
	// part: string index: The name of the source index to shrink
	// part: string target: The name of the target index to shrink into
	...
	// body:null
	// part: list index: A comma-separated list of index names; use `_all` or empty string to perform the operation on all indices
	// part: list metric: Limit the information returned the specific metrics.
	@GET("_stats")
	...
	// part: list index: A comma-separated list of index names to restrict the operation; use `_all` or empty string to perform the operation on all indices
	// part: list type: A comma-separated list of document types to restrict the operation; leave empty to perform the operation on all types
	@GET("_validate/query")
	...
	// param: time master_timeout: Explicit operation timeout for connection to master node
	// body:null
	// part: string id: Comma separated list of pipeline ids. Wildcards supported
	...
	// part: string index: The index of the document being count percolated to use as default
	// part: string type: The type of the document being percolated to use as default.
	@GET("_mpercolate")
	...
	// part: list index: A comma-separated list of index names to use as default
	// part: list type: A comma-separated list of document types to use as default
	@GET("_msearch")
	...
	// part: string index: The index in which the document resides.
	// part: string type: The type of the document.
	@GET("_mtermvectors")
	...
	// body:null
	// part: list node_id: A comma-separated list of node IDs or names to limit the returned information; use `_local` to return information from the node you're connecting to, leave empty to get information from all nodes
	// part: list metric: A comma-separated list of metrics you wish returned. Leave empty to return all.
	@GET("_nodes")
	...
	// body:null
	// part: list metric: Limit the information returned to the specified metrics
	// part: list index_metric: Limit the information returned for `indices` metric to the specific index metrics. Isn't used if `indices` (or `all`) metric isn't specified.
	// part: list node_id: A comma-separated list of node IDs or names to limit the returned information; use `_local` to return information from the node you're connecting to, leave empty to get information from all nodes
	@GET("_nodes/stats")
	...
	// part: string index: The index of the document being percolated.
	// part: string type: The type of the document being percolated.
	// part: string id: Substitute the document in the request body with a document that is known by the specified id. On top of the id, the index and type parameter will be used to retrieve the document from within the cluster.
	...
	// body:null
	// part: string task_id: The task id to rethrottle
	...
	// part: string id: The id of the stored search template
	...
	// part: string scroll_id: The scroll ID
	@GET("_search/scroll")
	...
	// part: string repository: A repository name
	// part: string snapshot: A snapshot name
	...
	// param: time timeout: Explicit operation timeout
	// body:null
	// part: list repository: A comma-separated list of repository names
	...
	// body:null
	// part: string repository: A repository name
	// part: list snapshot: A comma-separated list of snapshot names
	...
	// body:null
	// part: string task_id: Cancel the task with specified task id (node_id:task_number)
	@POST("_tasks/_cancel")
	...
	// body:null
	// part: string task_id: Return the task with specified id (node_id:task_number)
	@GET("_tasks/{task_id}")
	...
	// part: string index: The index in which the document resides.
	// part: string type: The type of the document.
	// part: string id: The id of the document, when not specified a doc param should be supplied.
