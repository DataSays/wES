...
import org.datasays.wes.types.EnumLevel;
import org.datasays.wes.types.EnumWaitForEvents;
import org.datasays.wes.types.EnumWaitForStatus;

/**
 * documentation: http://www.elastic.co/guide/en/elasticsearch/reference/master/cluster-health.html
 **/
public class ClusterHealth extends RequestInfo {

	public ClusterHealth(String baseUrl) {
		super(baseUrl);
	}

	public ClusterHealth(HttpUrl baseUrl) {
		super(baseUrl);
	}
